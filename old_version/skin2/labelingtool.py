...
class labelingTool():
    def __init__(self):
        ...
        self.settings = pd.read_pickle('settings4' + '.pkl')
    ...
    def _init_app(self):
        ...
        self.f = plt.Figure(figsize=(11, 5), dpi=100)
        ...
        self.plotSlider = Scale(self.master, from_=0, to=self.data_stream.shape[2] - 1 - self.windowsSize, length=100,
                                orient=HORIZONTAL,
